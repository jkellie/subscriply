class Organization::SubscriptionsController < Organization::BaseController
  ...
  def create
    @subscription_wizard = Organization::SubscriptionWizard.new(organization: current_organization)
    @subscription_wizard.attributes = params[:organization_subscription_wizard]
  ...
  def add
    subscription_creator = Organization::SubscriptionCreator.new(subscription_params)
  ...
  def postpone
    subscription_postponer = Organization::SubscriptionPostponer.new(@subscription)
  ...
  def terminate
    subscription_terminator = Organization::SubscriptionTerminator.new(@subscription)
