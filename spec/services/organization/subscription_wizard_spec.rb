...
describe Organization::SubscriptionWizard, '#initialize' do
  let(:organization) { FactoryGirl.create(:organization) }

  subject { Organization::SubscriptionWizard.new(organization: organization) }
...
describe Organization::SubscriptionWizard, '#attributes=' do
  let!(:organization) { FactoryGirl.create(:organization) }
  let!(:subscription_wizard) { Organization::SubscriptionWizard.new(organization: organization) }
...
describe Organization::SubscriptionWizard, "#create" do
