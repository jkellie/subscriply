...
describe Billing::NotificationFactory, '.build_notification' do
  ...
  context 'with a not implemented or unrecognized notification' do
    let(:body) {
      %Q{<thecakeisalie>
        <account>
    ...
    it "returns an instance of NullNotification" do
      expect(subject.class).to eq(Billing::Notification::NullNotification)
    end
  end
  ...
  context 'with a expired subscription notification' do
    let(:body) { 
      %Q{<expired_subscription_notification>
          <account>
            <account_code>1</account_code>
            <username nil="true"></username>
            <email>verena@example.com</email>
    ...
    it 'sends a message to the right notification class' do
      expect(subject.class).to eq(Billing::Notification::ExpiredSubscription)
    end
  end

  context 'with a renewed subscription notification' do
    let(:body) { 
      %Q{<renewed_subscription_notification>
          <account>
            <account_code>1</account_code>
            <username nil="true"></username>
            <email>verena@example.com</email>
    ...
    it 'sends a message to the right notification class' do
      expect(subject.class).to eq(Billing::Notification::RenewedSubscription)
    end
  end
